...
public enum XBoxAxes {
	...
	LEFTY(1),
	/**
	 * The value of the left trigger only.  This will only ever be positive
	 * and does not take into account the right trigger.
	 * 
	 * @see XBoxAxes#TRIGGER
	 */
	LTRIGGER(2),
	/**
	 * The value of the right trigger only.  This will only ever be positive
	 * and does not take into account the left trigger.
	 * 
	 * @see XBoxAxes#TRIGGER
	 */
	RTRIGGER(3),
